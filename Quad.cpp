...
Quad::Quad(double up , double down, double right, double left, const char* sn) :m_up(up), m_down(down), m_right(right), m_left(left) {//constructor. center point = (0,0), name=sn
	setName(sn);

}
Quad::Quad(const Quad& other) {		//copy constructr
